...
public class ArticleController {
    ...
    @GetMapping
    public ApiResponse<ArticleListResponseDto> getArticles(
    ...
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "카테고리별 게시글 목록 조회 성공"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "서버 오류")
    })
    @GetMapping("/{category_pk}")
    public ApiResponse<ArticleListResponseDto> getArticlesByCategory(
    ...
    public ApiResponse<ArticleResponseDto> createArticle(
        ...
        return ApiResponse.of(ApiStatusCode.CREATED, response);
    }
    ...
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "게시글 추천 성공"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "자신의 게시글 추천 불가"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "게시글을 찾을 수 없음"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "서버 오류")
    })
    @PostMapping("/{article_pk}/recommends")
    public ApiResponse<Void> recommendArticle(
            @Parameter(description = "게시글 ID") @PathVariable("article_pk") String id) {
        // TODO: 인증된 사용자 정보 활용
        articleService.recommendArticle(id, TEMP_USER_ID);
        
        return ApiResponse.success("게시글을 추천하였습니다.", null);
    }
    ...
    public ApiResponse<ArticleResponseDto> addComment(
    ...
    public ApiResponse<ArticleResponseDto> deleteComment(
            @Parameter(description = "게시글 ID") @PathVariable("article_pk") String articleId,
